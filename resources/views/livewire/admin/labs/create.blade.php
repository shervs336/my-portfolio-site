    ...
    <div class="card-body">
        <form class="w-full max-w-lg">
            ...
            <div class="d-grid gap-2">
                <button wire:click.prevent="storeLab()" class="shadow uppercase text-xs tracking-wide text-white bg-purple-500 hover:bg-purple-400 focus:shadow-outline focus:outline-none font-bold py-2 px-4 rounded">Save</button>
